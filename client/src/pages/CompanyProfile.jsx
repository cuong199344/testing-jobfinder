      ...
      <div className="">
        <div className="w-full flex flex-col md:flex-row gap-3 justify-between">
          <h2 className="text-gray-600 text-2xl font-semibold">
            Welcome,{" "}
            <span className="text-3xl bg-gradient-to-r from-blue-500 to-teal-400 bg-clip-text text-transparent">
              {info?.name}
            </span>
          </h2>
        ...
        <div className="w-full flex flex-col md:flex-row justify-start md:justify-between my-4 md:mt-8 text-sm">
        ...
        <div className="container mx-auto flex flex-col gap-5 2xl:gap-10 px-5 py-6 bg-[#f7fdfd]">
          <h2 className="text-gray-600 text-xl font-semibold mb-2 md:mb-0">
            About us:
          </h2>
          <p>{info?.about}</p>
        </div>
