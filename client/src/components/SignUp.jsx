            ...
            >
              ...
              >
                ...
                >
                  ...
                  {/* Chọn tài khoản muốn tạo, user hoặc company */}
                  <div className="w-full flex items-center justify-center py-4 ">
                    <button
                      className={`flex-1 px-4 py-2 rounded text-sm outline-none mr-1 ${
                        accountType === "seeker"
                          ? "bg-[#1d4fd862] text-white font-semibold"
                    ...
                    <button
                      className={`flex-1 px-4 py-2 rounded text-sm outline-none ml-1 ${
                        accountType !== "seeker"
                          ? "bg-[#1d4fd862] text-white font-semibold"
                          : "bg-white border border-blue-400"
                      }`}
